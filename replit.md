...
- July 15, 2025. **ERREUR TABLE USER_ROLES PRODUCTION RÉSOLUE** - Table user_roles manquante dans base PostgreSQL production
- July 15, 2025. **SCRIPT CORRECTION USER_ROLES CRÉÉ** - fix-user-roles-table-production.sh pour création automatique table + index
