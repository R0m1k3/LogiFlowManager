...
echo "  ✅ DONNÉES TEST SUPPRIMÉES - Groupes et fournisseurs de test automatiques éliminés"
echo "  ✅ init.sql nettoyé - Plus de création automatique de données Frouard/Nancy/Metz"
